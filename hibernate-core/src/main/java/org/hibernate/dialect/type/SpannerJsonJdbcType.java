...
/**
 * Spanner requires binding JSON via standard string mechanisms with a specific vendor type.
 */
public class SpannerJsonJdbcType extends JsonJdbcType {
	...
	protected SpannerJsonJdbcType(EmbeddableMappingType embeddableMappingType) {
